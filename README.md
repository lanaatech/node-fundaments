...
node-fundamentos/
├── /modulo_01
│ ├── atv01.js → Verificador de Maioridade 
│ ├── atv02.js → Calculadora de Soma Simples
...
Como a pasta node_modules não é enviada para o GitHub (por boas práticas de desenvolvimento), você precisará "reconstruir" as bibliotecas necessárias para isso entre na pasta do projeto com o comando abaixo:

cd node-fundaments

E instale as dependências listadas no package.json com: 
